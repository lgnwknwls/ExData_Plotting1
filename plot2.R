#Code to Create plot2.png of ExData_Plotting1 assignment
...
#Organize Data for Plot 2
householdData <- data.table(householdData, dateTimeMerge = paste(householdData$Date,householdData$Time, sep = " "))

#Generate Plot 2 in PNG
png(file="plot2.png", width = 480, height = 480)
with(householdData, plot(as.POSIXct(dateTimeMerge), Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab=""))
dev.off()